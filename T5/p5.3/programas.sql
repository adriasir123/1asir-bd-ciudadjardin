...
insert into programas values(20, 'La prisión', '10');
...
insert into clientes values (1, 'Pepe Pérez', 45);
insert into clientes values (2, 'Juan González', 45);
insert into clientes values (3, 'María Gómez', 33);
insert into clientes values (4, 'Javier Casado', 18);
insert into clientes values (5, 'Nuria Sánchez', 29);
